...
public class AlipayConfig {
    ...
    //设置应用公钥证书路径
    public static String app_cert_path = "D:\\桌面\\playball\\appCertPublicKey.crt";
    
    //设置支付宝公钥证书路径
    public static String alipay_cert_path = "D:\\桌面\\playball\\alipayCertPublicKey_RSA2.crt";
    
    //设置支付宝根证书路径
    public static String alipay_root_cert_path = "D:\\桌面\\playball\\alipayRootCert.crt";
