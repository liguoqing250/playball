...
@Api(tags="订单管理")
@RestController
@RequestMapping("/playball/playballOrder")
public class PlayballOrderController extends JeecgController<PlayballOrder, IPlayballOrderService> {
	@Autowired
	private IPlayballOrderService playballOrderService;
	...
	public Result<?> queryPageList(PlayballOrderModel playballOrderModel,
		...
		log.info("-----------"+playballOrderModel);
		IPage<PlayballOrderModel> pageList = playballOrderService.queryOrderList(new Page(pageNo,pageSize), playballOrderModel);
