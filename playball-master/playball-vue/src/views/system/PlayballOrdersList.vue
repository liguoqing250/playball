<template>
  <a-card :bordered="false">
    ...
    <!-- 表单区域 -->
    <playballOrders-modal ref="modalForm" @ok="modalFormOk"></playballOrders-modal>
  </a-card>
</template>

<script>
  import '@/assets/less/TableExpand.less'
  import PlayballOrdersModal from './modules/PlayballOrdersModal'
  import { JeecgListMixin } from '@/mixins/JeecgListMixin'

  export default {
    name: "PlayballOrdersList",
    ...
    data () {
      return {
		...
		url: {
          list: "/playball/playballOrder/list",
          delete: "/playball/playballOrder/delete",
          deleteBatch: "/playball/playballOrder/deleteBatch",
          exportXlsUrl: "playball/playballOrder/exportXls",
          importExcelUrl: "playball/playballOrder/importExcel",
       },
    }
  },
  computed: {
