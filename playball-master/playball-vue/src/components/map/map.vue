<template>
  <div :style="{width}">
    ...
    <div class="map-search">
      ...
      <a-input type="text" placeholder="输入搜索位置" v-model.trim="search" @keyup.enter="getLatLngBounds" style="width:240px"></a-input>

      <a-button  type="primary" @click="getLatLngBounds" icon="search" style="margin-left:20px">搜索</a-button>
    </div>
...
export default {
  ...
  props: {
    ...
    mapKey: {
      type: String,
      default: 'YYJBZ-XWTCX-3QB47-7XVXO-GL7BT-J7B4C'
    },
    //设置地图宽度
    width: {
      type: String,
